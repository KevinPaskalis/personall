...
<link rel="preconnect" href="https://fonts.googleapis.com">
    ...
    <link href="https://drive.google.com/uc?export=view&id=1yFuxnd1AqPeAqwJCx99HADz64UKMLgw4" rel="stylesheet" type="text/css" />
    <script src="https://hbd.htmlku.repl.co/script.js">

    </script>
<head>
<!-- Edit Judul Script di Sini -->
  <title>Untuk SOFIA</title>
...
<!-- Pesan -->
<p><b><br>
	<span>SELAMAT ULANG TAHUN YA SOFIA CANTIKK </span>
</b></p>
...
<p><b><br>
	<span>SEHAT SELALU</span>
</b></p>

<p><b><br>
	<span>SAYANG KE KELUARGANYA</span>
</b></p>

<p><b><br>
	<span>KALAU MAU SAYANG KE KEPAS JUGA BOLEH</span>
</b></p>
...
<script>
  ...
  async function jawab(){var { value: jawaban } = await swals.fire({
   ...
   if(jawaban && jawaban.length < 21){window.jawaban = jawaban;pesanwhatsapp = jawaban;menuju();} else {await swals.fire('Ups!', 'Kolom tidak boleh kosong atau lebih dari 20 karakter, ya!');}
   }
...
<script type="text/javascript">
       async function pertama(){
            ...
            akhirkata = "Cieeee yangg 18 tahun eakk";
            akhirkata2 = "Doa ku buatkau sama jih kayak doa mu hehe, rajin-rajin belajar bahasa jepang oh pernah kubilangkan ko hahaha ada jih org selalu mau sama kau tapi masih blum berani na ungkap kan na tunggu dulu semuanya membaik, pasti mutau jih siapa itu orang haha sayalah siapa lagi tapi sekarang nda ku paksa joko kembali kesaya kalo memang nda mau moko sama saya yahh ndapp jih, sama kalo moko cari orang baru kudukung joko yang penting baik jih itu orang, jujur waktu ku tau kalau dekat ko sama jujak sakit sekali hati ku wkwkwk menangis na subuh2 haha tapi sadar mok juga disitu nda bisa na paksa ko buat kembali ke saya sama nda bisa na larang2 ko untuk dekat sama orang lain, toh kan kalo memang masih ada jih perasaan mu kesaya pasti akan kembali joko keterima jih ia yang penting nda pacaran poko sama orang lain, itu jih sih yang mau kubilang, eh satu pi kalau nda mau moko sama saya masih bisa jikik jadi teman baik ";
            palingakhir.innerHTML = "LOVEE YOUUU SOFIAA<3";
